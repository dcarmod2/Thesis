...
$\mbb GW$ as a periodization of $GW$. 
...
$\beta^\sigma \cup \mc O_{\Z[\frac{1}{2}]}[-1] \cup \langle 1 \rangle$ in $\mbb P^\sigma$,
...
between using $\alpha \otimes id$ or $id \otimes \alpha$, and these
