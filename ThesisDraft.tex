...
which is Noetherian of finite Krull dimension which has an ample
family of line bundles and $\frac{1}{2} \in \Gamma(S,\mc O_S)$. First we review the definition of the equivariant
...
\begin{theorem}
Let $S$ be a regular Noetherian scheme of finite Krull dimension, an ample
family of line bundles, and $\frac{1}{2} \in S$. Let $GW$ denote the Grothendieck-Witt space on $\Sm{S,qp}^{C_2}$, and let
...
\begin{theorem}
Let $S$ be a Noetherian scheme of finite Krull dimension, an ample
...
Hermitian $K$-theory $L_{\mbb A^1}\mbb GW$ on $\Sm{S,qp}^{C_2}$ for $S$ a Noetherian scheme of finite Krull dimension, an ample
