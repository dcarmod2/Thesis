...
trivial involution or a ring of the form $\mc O_{X,x}^h \times \mc
...
sequence, one obtains cdh descent for algebraic
$K$-theory, see \cite{DenRep}.

We first check that over a regular base $S$ with 2 invertible
(e.g. $\Z[\frac{1}{2}]$), hermitian $K$-theory is representable in the
category of smooth $C_2$-schemes, $\Sm{S}^{C_2}$. 

To
extend this result to non-regular bases, we utilize the
Morel-Voevodsky approach to classifying spaces and obtain
representability of homotopy hermitian $K$-theory (not ordinary
hermitian $K$-theory).
...
just $f^*(\RGr_d[\frac{1}{2}]$. The requirement that $V$ be non-degenerate is necessary so that the action
...
Let $\gamma$ be the map \eqref{eq:gamma}. Then $\mbb GW \cong Q_\gamma GW$.
\end{corollary}
