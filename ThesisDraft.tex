...
O(-1)$ is induced via adjunction by the composition 
\[
...
\]
These are equal since $\frac{T+S}{2}$ is an invariant global section. Denote
the form given by the diagram \ref{diag:prebott} by $\phi$.
...
GW^{[n-1]}(X,-\can) \cong GW^{[n+1]}(X)$, recovering one of the results of
  \cite{Xie2018ATM}. It follows that
\[
